...
#define MBED_CONF_LORA_APPLICATION_KEY                                    {0x50,0x03,0x79,0xf8,0x82,0x92,0x11,0x88,0xcc,0x6d,0x5b,0x46,0x50,0x9b,0xce,0xe8}                // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_EUI                                         { 0x9a, 0x9e, 0x4b, 0x76, 0xed, 0xbe, 0x71, 0x27 }                                               // set by application[*]
...
#define MBED_CONF_LWIP_MBOX_SIZE                                          1                                                                                                // set by application[*]
...
#define MBED_CONF_LWIP_MEM_SIZE                                           256                                                                                              // set by application[*]
...
#define MBED_CONF_LWIP_NUM_NETBUF                                         1                                                                                                // set by application[*]
...
#define MBED_CONF_LWIP_SOCKET_MAX                                         1                                                                                                // set by application[*]
...
#define MBED_CONF_RTOS_MAIN_THREAD_STACK_SIZE                             2048                                                                                             // set by application[*]
...
#define NDEBUG                                                            0                                                                                                // defined by application
